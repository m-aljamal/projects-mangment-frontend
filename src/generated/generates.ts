...
export type QueryFindStudentsByProjectArgs = {
  ...
  projectId: Scalars['String'];
  sortDivision?: InputMaybe<Sort>;
  sortLevel?: InputMaybe<Sort>;
};
...
export type FindStudentsByProjectQuery = { __typename?: 'Query', findStudentsByProject: Array<{ __typename?: 'Student', fatherName: string, firstName: string, lastName: string, id: string, phone: string, division: { __typename?: 'Division', divisionName: string, divisionNumber: number, id: string }, level: { __typename?: 'Level', id: string, levelName: string, levelNumber: number } }> };
...
export const FindStudentsByProjectDocument = `
    query findStudentsByProject($projectId: String!, $levelName: String, $divisionName: String, $sortDivision: Sort, $sortLevel: Sort) {
