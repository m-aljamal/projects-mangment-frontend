...
export const CreateEmployeeDocument = `
  ...
  createEmployee(
    employee: {name: $name, username: $username, password: $password, projectId: $projectId, salary: $salary, role: $role, jopTitle: $jopTitle, divisions: $divisions, levels: $levels, avatar: $avatar}
  ) {
    createdAt
    id
    name
